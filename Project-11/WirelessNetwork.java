...
public abstract class WirelessNetwork implements Comparable<WirelessNetwork> {
   ...
   public String toString() {
      ...
      //Webcat wants you to format it with commas
   ...
   /**
    * This is an abstract method.
    *@return compareWire to compare int
    *@param wireNet to take in network
    */
   public int compareTo(WirelessNetwork wireNet) {
      int compareWire = this.getName().toLowerCase()
                            .compareTo(wireNet.getName().toLowerCase());
      return compareWire;
   }
   /**
    *@return isNametrue?
    *@param obj for equality
    */
   ...
   public boolean equals(Object obj) {
      if (!(obj instanceof WirelessNetwork)) {
         ...
         WirelessNetwork c = (WirelessNetwork) obj;
